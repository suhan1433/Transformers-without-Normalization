from model.decoder_post import DecoderBlock
from model.encoder_post import EncoderBlock
import torch
...
class Transformer(nn.Module):
    ...
    def forward(self, x, y, attention_mask_src):
        ...
        for decoder in self.decoder:
            h, _, _, _, _ = decoder(h, z, mask_dec, None, future_mask)
